...
public class flamethrower : MonoBehaviour {
	...
	void Update () 
	{
		...
		if ((ControlFreak2.CF2Input.GetButton("Fire1") || ControlFreak2.CF2Input.GetAxis ("Fire1")>0.1) && canfire && !isreloading && !myanimation.IsPlaying (readyAnim.name)&& !myanimation.IsPlaying (hideAnim.name))
		{
