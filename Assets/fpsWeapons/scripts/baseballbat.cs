...
public class baseballbat : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (ControlFreak2.CF2Input.GetButton("ThrowGrenade") && !GetComponent<Animation>().isPlaying && inventory.grenade>0)
		{
		...
		if (ControlFreak2.CF2Input.GetButton("Fire1") && canfire || ControlFreak2.CF2Input.GetAxis ("Fire1")>0.1 && canfire )
		{
			fire();
		}
	}
